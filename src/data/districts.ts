// 행정안전부 행정구역 데이터 (2024년 기준) — 전국 시도/시군구
export const DISTRICTS: string[] = [
  ...
  "인천광역시 서구", "인천광역시 연수구", "인천광역시 옹진군", "인천광역시 중구",
  ...
  // 경기도 (31개 시군)
  "경기도 가평군", "경기도 고양시", "경기도 과천시", "경기도 광명시",
  "경기도 광주시", "경기도 구리시", "경기도 군포시", "경기도 김포시",
  "경기도 남양주시", "경기도 동두천시", "경기도 부천시", "경기도 성남시",
  "경기도 수원시", "경기도 시흥시", "경기도 안산시", "경기도 안성시",
  "경기도 안양시", "경기도 양주시", "경기도 양평군", "경기도 여주시",
  "경기도 연천군", "경기도 오산시", "경기도 용인시", "경기도 의왕시",
...
export function formatDistrict(d: string): string {
  if (d === "세종특별자치시") return "세종시";
  return d
    .replace("특별시 ", "시 ")
    .replace("광역시 ", "시 ")
    .replace("특별자치도 ", " ")
